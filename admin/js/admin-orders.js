...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (downloadBtn && modal) {
        downloadBtn.addEventListener("click", function() {
            ...
            const orderDateRaw = order.orderDate || order.createdAt || order.date || order.timestamp || '';
                ...
                logo.onload = function() {
                    ...
                    if (userData) {
                        ...
                        if (order.customer) {
                            ...
                            if (!userName) userName = order.customer.name || '';
                            if (!userPhone) userPhone = order.customer.phone || '';
                        }
                    }
            ...
            // Get userId from order (if available)
...
function viewOrderDetails(userId, orderId) {
    ...
    database.ref(`orders/${userId}/${orderId}`).once('value').then(snapshot => {
        ...
        // Set order for invoice download
